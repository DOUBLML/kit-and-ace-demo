...
// Mock Data
const MOCK_BRANDS = [
  { id: "kit-and-ace", name: "Kit and Ace" },
  { id: "huha", name: "Huha" },
...
const MOCK_SKUS = [
  ...
  {
    id: "KA-MVP-WLPNT-002",
    name: "Maven Wide Leg Pants - Black",
    category: "Pants",
    status: "Active",
    totalOrders: 1156,
    avgLeadTimeDays: 5.8,
  ...
  {
    id: "KA-MVP-WLPNT-003",
    name: "Maven Wide Leg Pants - Navy",
    category: "Pants",
    status: "Pilot",
    totalOrders: 218,
    avgLeadTimeDays: 7.1,
  ...
  {
    id: "KA-MVP-WLPNT-004",
    name: "Maven Wide Leg Pants - Olive",
    category: "Pants",
    status: "In Dev",
    totalOrders: 0,
    avgLeadTimeDays: 0,
